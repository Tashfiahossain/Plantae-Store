        ...
        <a class="navbar-brand" href="#">Plantae Store</a>
         ...
         <div class="collapse navbar-collapse" id="navbarNavDropdown">
            <ul class="navbar-nav ml-auto">
               ...
               <li class="nav-item">
                  <a class="nav-link bi bi-person" href="#"></a>
               </li>
               <li class="nav-item">
                  <a class="nav-link bi bi-cart" href="#"></a>
               </li>
            </ul>
         </div>
      </nav>
...
$query = "select * from plant where Type ='Tool'";
...
<!-----------
       ...
       <div class="product text-center col-sm">
          <img class="img-fluid mb-3" src="images/tools/gardeningfork.jpg" style="height:250px" />
          <h5 class="p-name">Gardening Fork</h5>
          <h4 class="p-price">TK 250</h4>
          <button class="'buy-btn">Buy Now</button>
       </div>
       <div class="product text-center col-sm">
          <img class="img-fluid mb-3" src="images/tools/gloves.jpg" style="height:250px"/>
          <h5 class="p-name">Gloves</h5>
          <h4 class="p-price">TK 200</h4>
          <button class="'buy-btn">Buy Now</button>
       </div>
       <div class="product text-center col-sm">
          <img class="img-fluid mb-3" src="images/tools/handtrowel.jpg" style="height:250px"/>
          <h5 class="p-name">Hand Trowel</h5>
          <h4 class="p-price">TK 550</h4>
          <button class="'buy-btn">Buy Now</button>
       </div>
    ...
    <div class="row mx-auto container">
       <div class="product text-center col-sm">
          <img class="img-fluid mb-3" src="images/tools/loppers.jpg" style="height:250px" />
          <h5 class="p-name">Lopper</h5>
          <h4 class="p-price">TK 950</h4>
          <button class="'buy-btn">Buy Now</button>
       </div>
       <div class="product text-center col-sm">
          <img class="img-fluid mb-3" src="images/tools/plasticpot.jpg" style="height:250px"/>
          <h5 class="p-name">Plastic Pot</h5>
          <h4 class="p-price">TK 30</h4>
          <button class="'buy-btn">Buy Now</button>
       </div>
       <div class="product text-center col-sm">
          <img class="img-fluid mb-3" src="images/tools/pruning shear.jpg" style="height:250px"/>
          <h5 class="p-name">Pruning Shear</h5>
          <h4 class="p-price">TK 180</h4>
          <button class="'buy-btn">Buy Now</button>
       </div>
    </div>
    ...
    <div class="row mx-auto container">
       <div class="product text-center col-sm">
          <img class="img-fluid mb-3" src="images/tools/shovel.jpg" style="height:250px" />
          <h5 class="p-name">Shovel</h5>
          <h4 class="p-price">TK 200</h4>
          <button class="'buy-btn">Buy Now</button>
       </div>
       <div class="product text-center col-sm">
          <img class="img-fluid mb-3" src="images/tools/wateringcan.jpg" style="height:250px"/>
          <h5 class="p-name">Watering Can</h5>
          <h4 class="p-price">TK 80</h4>
          <button class="'buy-btn">Buy Now</button>
       </div>
       <div class="product text-center col-sm">
          <img class="img-fluid mb-3" src="images/tools/pipe.jpg" style="height:250px"/>
          <h5 class="p-name">Garden Hose Pipe</h5>
          <h4 class="p-price">TK 750</h4>
          <button class="'buy-btn">Buy Now</button>
       </div>
