...
<body>
   ...
   <section id="featured " class="pt-5 pb-5">
      <div class="container text-center mt-5 py-5">
         <h2>Indoor Plants</h2>
         <hr class="mx-auto">
         <p>Indoor plants improve concentration and productivity, reduce stress levels and boost your mood</p>
      </div>
...
$query = "select * from plant where Type ='Indoor'";
...
<!----
         <div class="product text-center col-sm">
            <img class="img-fluid mb-3" src="images/indoor/antheriium.jpeg" style="height:250px" />
            <h5 class="p-name">Antherium</h5>
            <h4 class="p-price">TK 850</h4>
            <button class="'buy-btn">Buy Now</button>
         </div>
         <div class="product text-center col-sm">
            <img class="img-fluid mb-3" src="images/indoor/arecapalm.jpg" style="height:250px"/>
            <h5 class="p-name">Areca Palm</h5>
            <h4 class="p-price">TK 220</h4>
            <button class="'buy-btn">Buy Now</button>
         </div>
         <div class="product text-center col-sm">
            <img class="img-fluid mb-3" src="images/indoor/caladium.jpg" style="height:250px"/>
            <h5 class="p-name">Caladium</h5>
            <h4 class="p-price">TK 160</h4>
            <button class="'buy-btn">Buy Now</button>
         </div>
      ...
      <div class="row mx-auto container">
         <div class="product text-center col-sm">
            <img class="img-fluid mb-3" src="images/indoor/christmastree.jpg" style="height:250px" />
            <h5 class="p-name">Christmas Tree</h5>
            <h4 class="p-price">TK 450</h4>
            <button class="'buy-btn">Buy Now</button>
         </div>
         <div class="product text-center col-sm">
            <img class="img-fluid mb-3" src="images/indoor/hangingbasket.jpg" style="height:250px"/>
            <h5 class="p-name">Hanging Basket</h5>
            <h4 class="p-price">TK 700</h4>
            <button class="'buy-btn">Buy Now</button>
         </div>
         <div class="product text-center col-sm">
            <img class="img-fluid mb-3" src="images/indoor/moneyplant.jpg" style="height:250px"/>
            <h5 class="p-name">Money Plant</h5>
            <h4 class="p-price">TK 150</h4>
            <button class="'buy-btn">Buy Now</button>
         </div>
      ...
      <div class="row mx-auto container">
         <div class="product text-center col-sm">
            <img class="img-fluid mb-3" src="images/indoor/kaminibonsai.jpg" style="height:250px" />
            <h5 class="p-name">Kamini Bonsai</h5>
            <h4 class="p-price">TK 450</h4>
            <button class="'buy-btn">Buy Now</button>
         </div>
         <div class="product text-center col-sm">
            <img class="img-fluid mb-3" src="images/indoor/silverqueen.jpg" style="height:250px"/>
            <h5 class="p-name">Silver Queen</h5>
            <h4 class="p-price">TK 250</h4>
            <button class="'buy-btn">Buy Now</button>
         </div>
         <div class="product text-center col-sm">
            <img class="img-fluid mb-3" src="images/indoor/snakeplant.jpg" style="height:250px"/>
            <h5 class="p-name">Snake Plant</h5>
            <h4 class="p-price">TK 250</h4>
            <button class="'buy-btn">Buy Now</button>
         </div>
        ---->
