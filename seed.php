...
$query = "select * from plant where Type ='Seed'";
...
?>
       ...
       <div class="product text-center col-sm">
          <img class="img-fluid mb-3" src="images/seed/bean.jpg" style="height:250px"/>
          <h5 class="p-name">Bean</h5>
          <h4 class="p-price">TK 60</h4>
          <button class="'buy-btn">Buy Now</button>
       </div>
       <div class="product text-center col-sm">
          <img class="img-fluid mb-3" src="images/seed/brinjal.jpg" style="height: 250px" />
          <h5 class="p-name">Brinjal</h5>
          <h4 class="p-price">TK 60</h4>
          <button class="'buy-btn">Buy Now</button>
       </div>
      <div class="product text-center col-sm">
          <img class="img-fluid mb-3" src="images/seed/broccoli.jpg" style="height: 250px" />
          <h5 class="p-name">Broccoli</h5>
    ...
    <div class="row mx-auto container">
      <div class="product text-center col-sm">
         <img class="img-fluid mb-3" src="images/seed/cauliflower.jpg" style="height: 250px"/>
         <h5 class="p-name">Cauliflower</h5>
         <h4 class="p-price">TK 55</h4>
         <button class="'buy-btn">Buy Now</button>
      </div>
      <div class="product text-center col-sm">
         <img class="img-fluid mb-3" src="images/seed/gourd.png" style="height: 250px"/>
         <h5 class="p-name">Groud</h5>
         <h4 class="p-price">TK 45</h4>
         <button class="'buy-btn">Buy Now</button>
      </div>
     <div class="product text-center col-sm">
         <img class="img-fluid mb-3" src="images/seed/greenchili.jpg" style="height: 250px" />
         <h5 class="p-name">Green Chili</h5>
         <h4 class="p-price">TK 45</h4>
         <button class="'buy-btn">Buy Now</button>
      </div>
   </div>
   ...
   <div class="row mx-auto container">
      <div class="product text-center col-sm">
         <img class="img-fluid mb-3" src="images/seed/pumpkin.jpg" style="height: 250px"/>
         <h5 class="p-name">Pumpkin</h5>
         <h4 class="p-price">TK 30</h4>
         <button class="'buy-btn">Buy Now</button>
      </div>
      <div class="product text-center col-sm">
         <img class="img-fluid mb-3" src="images/seed/radish.jpg"  style="height:250px" />
         <h5 class="p-name">Radish</h5>
         <h4 class="p-price">TK 50</h4>
         <button class="'buy-btn">Buy Now</button>
      </div>
     <div class="product text-center col-sm">
         <img class="img-fluid mb-3" src="images/seed/tomato.jpg" style="height: 250px;" />
