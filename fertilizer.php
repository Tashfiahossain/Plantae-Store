...
<body>
   ...
   <section id="featured " class="pt-5 pb-5">
    <div class="container text-center mt-5 py-5">
       <h2>Fertilizer</h2>
       <hr class="mx-auto">
       <p>Fertilizer will increase plants productivity</p>
    </div>
    <div class="row mx-auto container">

    <?php

$query = "select * from plant where Type ='Fertilizer'";
...
<!-----
       ...
       <div class="product text-center col-sm">
          <img class="img-fluid mb-3" src="images/fertilizer/bonemeal.jpg" style="height:250px" />
          <h5 class="p-name">Bone Meal-1kg</h5>
          <h4 class="p-price">TK 60</h4>
          <button class="'buy-btn">Buy Now</button>
       </div>
       <div class="product text-center col-sm">
          <img class="img-fluid mb-3" src="images/fertilizer/dapgarden.jpg" style="height:250px"/>
          <h5 class="p-name">Dap Garden</h5>
          <h4 class="p-price">TK 300</h4>
          <button class="'buy-btn">Buy Now</button>
       </div>
       <div class="product text-center col-sm">
          <img class="img-fluid mb-3" src="images/fertilizer/urea.jpg" style="height:250px"/>
          <h5 class="p-name">Urea-1kg</h5>
          <h4 class="p-price">TK 27</h4>
          <button class="'buy-btn">Buy Now</button>
       </div>
    ...
    <div class="row mx-auto container">
       <div class="product text-center col-sm">
          <img class="img-fluid mb-3" src="images/fertilizer/mop300g.jpg" style="height:250px" />
          <h5 class="p-name">MOP-300g</h5>
          <h4 class="p-price">TK 22</h4>
          <button class="'buy-btn">Buy Now</button>
       </div>
       <div class="product text-center col-sm">
          <img class="img-fluid mb-3" src="images/fertilizer/roothormonepowder.jpg" style="height:250px"/>
          <h5 class="p-name">Root Hormone Powder-100g</h5>
          <h4 class="p-price">TK 60</h4>
          <button class="'buy-btn">Buy Now</button>
       </div>
       <div class="product text-center col-sm">
          <img class="img-fluid mb-3" src="images/fertilizer/tsp.jpg" style="height:250px"/>
          <h5 class="p-name">TSP-500gm</h5>
          <h4 class="p-price">TK 40</h4>
          <button class="'buy-btn">Buy Now</button>
       </div>
    </div>
    ...
    <div class="row mx-auto container">
       <div class="product text-center col-sm">
          <img class="img-fluid mb-3" src="images/fertilizer/diammoniumphosphate.jpg" style="height:250px" />
          <h5 class="p-name">Di Ammonium Phospate-100g</h5>
          <h4 class="p-price">TK 40</h4>
          <button class="'buy-btn">Buy Now</button>
       </div>
       <div class="product text-center col-sm">
          <img class="img-fluid mb-3" src="images/fertilizer/vermicompost.jpg" style="height:250px"/>
          <h5 class="p-name">Vermicompost</h5>
          <h4 class="p-price">TK 100</h4>
          <button class="'buy-btn">Buy Now</button>
       </div>
       <div class="product text-center col-sm">
          <img class="img-fluid mb-3" src="images/fertilizer/zincsulphate.jpg" style="height:250px"/>
          <h5 class="p-name">Zinc Sulphate-500g</h5>
          <h4 class="p-price">TK 90</h4>
          <button class="'buy-btn">Buy Now</button>
       </div>
