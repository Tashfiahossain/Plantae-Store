...
<body>
   ...
   <section id="featured " class="pt-5 pb-5">
      <div class="container text-center mt-5 py-5">
         <h2>Bouquet</h2>
         <hr class="mx-auto">
         <p>Send a bouquet to someone special to brighten their day.</p>
      </div>
      <div class="row mx-auto container">

      <?php

$query = "select * from plant where Type ='Bouquet'";
...
<!-----
         <div class="product text-center col-sm">
            <img class="img-fluid mb-3" src="images/Bouqet/b3.jpg" style="height:250px" />
            <h5 class="p-name">Bouquet-1</Bouqet-1></h5>
            <h4 class="p-price">TK 850</h4>
            <button class="'buy-btn">Buy Now</button>
         </div>
         <div class="product text-center col-sm">
            <img class="img-fluid mb-3" src="images/Bouqet/b2.jpg" style="height:250px"/>
            <h5 class="p-name">Bouquet-2</h5>
            <h4 class="p-price">TK 600</h4>
            <button class="'buy-btn">Buy Now</button>
         </div>
         <div class="product text-center col-sm">
            <img class="img-fluid mb-3" src="images/Bouqet/b4.jpg" style="height:250px"/>
            <h5 class="p-name">Bouquet-3</h5>
            <h4 class="p-price">TK 500</h4>
            <button class="'buy-btn">Buy Now</button>
         </div>
      ...
      <div class="row mx-auto container">
         <div class="product text-center col-sm">
            <img class="img-fluid mb-3" src="images/Bouqet/b5.jpeg" style="height:250px" />
            <h5 class="p-name">Bouquet-4</h5>
            <h4 class="p-price">TK 750</h4>
            <button class="'buy-btn">Buy Now</button>
         </div>
         <div class="product text-center col-sm">
            <img class="img-fluid mb-3" src="images/Bouqet/b6.jpg" style="height:250px"/>
            <h5 class="p-name">Bouquet-5</h5>
            <h4 class="p-price">TK 1300</h4>
            <button class="'buy-btn">Buy Now</button>
         </div>
         <div class="product text-center col-sm">
            <img class="img-fluid mb-3" src="images/Bouqet/b7.jpg" style="height:250px"/>
            <h5 class="p-name">Bouquet-6</h5>
            <h4 class="p-price">TK 1850</h4>
            <button class="'buy-btn">Buy Now</button>
         </div>
      ...
      <div class="row mx-auto container">
         <div class="product text-center col-sm">
            <img class="img-fluid mb-3" src="images/Bouqet/b8.jpg" style="height:250px" />
            <h5 class="p-name">Bouquet-7</h5>
            <h4 class="p-price">TK 1360</h4>
            <button class="'buy-btn">Buy Now</button>
         </div>
         <div class="product text-center col-sm">
            <img class="img-fluid mb-3" src="images/Bouqet/b9.jpg" style="height:250px"/>
            <h5 class="p-name">Bouquet-8</h5>
            <h4 class="p-price">TK 900</h4>
            <button class="'buy-btn">Buy Now</button>
         </div>
         <div class="product text-center col-sm">
            <img class="img-fluid mb-3" src="images/Bouqet/b10.jpg" style="height:250px"/>
            <h5 class="p-name">Bouquet-9</h5>
            <h4 class="p-price">TK 850</h4>
            <button class="'buy-btn">Buy Now</button>
         </div>
        ---->
